...
- **Shared-address watch:** automatically compares retained coinbase recipients across original source labels/tags, with block evidence, reward fractions and coverage. Shared miner addresses are not ownership evidence; matches never merge pool identities.
