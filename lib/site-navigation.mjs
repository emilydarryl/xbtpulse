const tools=[['/compare','Compare pools'],['/simulator','Mining simulator'],['/miner-checker','Who builds my block?'],['/trends','Trends & changes'],['/mining-map','Mining map']];
