...
flush()
page='''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Install the DATUM collector · XBT Pulse</title><link rel="stylesheet" href="/style.css"><link rel="icon" href="/favicon.svg"></head><body><header class="topbar"><a class="brand" href="/" aria-label="XBT Pulse home"><img src="/favicon.svg" width="34" height="34" alt="" /><span>XBT<span class="brand-light">PULSE</span></span></a><a href="/contribute">Operator registration →</a><a class="main-site-link" href="/">← Main site</a></header><main class="contribute-main"><p class="eyebrow">OPERATOR-INSTALLED TELEMETRY</p><h1>Run your own collector.</h1><p>No SSH access to your server is needed by XBT Pulse. You install and control the software.</p><p><a class="primary-button" href="/downloads/'''+name+'''" download>Download DATUM collector v1.0.0</a></p><p><a href="/downloads/SHA256SUMS.txt">SHA-256 checksum</a> · <a href="/downloads/SHA256SUMS.txt.sig">Signature</a> · <a href="/verify-downloads">Verify downloads</a> · <a href="/contribute">Register your pool</a></p><article class="panel intake-panel">'''+''.join(parts)+'''</article><footer><a href="/contribute">Return to contribution page →</a></footer></main></body></html>'''
